...
public class ExcelReader {
    ...
    private static ExcelDataVO convertRowToData(Row row) {
        ...
        resultData.setLongitude(longitude);
        // 获取纬度
        cell = row.getCell(cellNum++);
        String latitude = convertCellValueToString(cell);
        resultData.setLatitude(latitude);
        // 获取海拔
        cell = row.getCell(cellNum++);
        String altitude = convertCellValueToString(cell);
        resultData.setAltitude(altitude);
        // 获取定位结果
        cell = row.getCell(cellNum++);
        String result = convertCellValueToString(cell);
