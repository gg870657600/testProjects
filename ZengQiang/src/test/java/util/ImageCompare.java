...
//比较两张图片的相似度     调用     ImageCompare.compareTest(srcFile1, srcFile2);
//感觉比较不太稳定
public class ImageCompare {
    ...
    public static void compareTest(File file1, File file2) {
        double percentDefault = 99.99;
        float percent = compare(getData(file1),getData(file2));
        if (percent == 0) {
